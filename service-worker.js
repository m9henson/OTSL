const CACHE='ostl-supabase-1.7';
const FILES=['./','./index.html','./app-v1.7.js?v=17','./styles.css','./supabase-config.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
